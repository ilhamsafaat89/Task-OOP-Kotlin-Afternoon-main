 ...
 */
fun myTeam(): List<Any> {
    val groupMembers = listOf("Maya", "Nanda", "Ilham", "Hasan", "Faqih", "Eva")
...
fun totalMember(): Int {
    ...
    val countOfGroup = arrayOf<String>("Maya", "Nanda", "Ilham", "Hasan", "Faqih", "Eva")
...
fun main() {
     ...
     *
     */
    groupDetail("Omnidev", listOf("Maya, Nanda, Ilham, Hasan, Faqih, Eva"), "Afternoon")
